    ...
    return (
        <View style={{ flexDirection: 'row', height: 60, backgroundColor: 'black' }}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'white' }}>{header}</Text>
            </View>
        </View >
    )
}
...
export default function Home({ navigation }) {
    ...
    const nData = (data) => {
        ...
        db.transaction(
            tx => {
                tx.executeSql("insert into itemson (name, place, advance,hour,minutes,choosedate,wheeler) values (?, ?,?, ?, ?, ?, ?)", [data.name, data.place, data.advance, 0, 0, (choosedate).toString(), checked]);
                tx.executeSql(
                    `select * from itemson ;`,
                    [],
                    (_, { rows: { _array } }) =>
                ...
                tx.executeSql(
                    "create table if not exists " + "" + data.name.replace(/ +/g, '') + "" + " (id integer primary key not null, advance text, hour text,minutes text,choosedate text,wheeler text);"
                );
                tx.executeSql("insert into " + "" + data.name.replace(/ +/g, '') + "" + " (advance,hour,minutes,choosedate,wheeler) values (?,?,?,?,?)", [data.advance, 0, 0, choosedate, checked]);
            },
    ...
    return (
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={{ flex: 1, backgroundColor: 'black' }}>
                    ...
                    >
                        {(props) => (
                            <View style={{ padding: 38, paddingBottom: 10, paddingTop: 0 }}>
                                <TextInput
                                    style={styles.textinput, { textAlign: 'center', alignItems: 'center', borderWidth: 1, height: 40, color: 'white', backgroundColor: '#101010', borderBottomColor: 'white', borderRadius: 7 }}
                                    placeholder='Enter Name'
                                    onChangeText={props.handleChange('name')}
                                    value={props.values.name}
                                />
                                <Text style={{ fontSize: 10, color: 'white', textAlign: 'center' }}>{props.touched.name && props.errors.name}</Text>
                                <TextInput
                                    style={styles.textinput, { textAlign: 'center', borderWidth: 1, height: 40, color: 'white', backgroundColor: '#101010', borderBottomColor: 'white', borderRadius: 7 }}
                                ...
                                />
                                <Text style={{ fontSize: 10, color: 'white', textAlign: 'center' }}>{props.touched.place && props.errors.place}</Text>
                                <TextInput
                                    style={styles.textinput, { textAlign: 'center', borderWidth: 1, height: 40, color: 'white', backgroundColor: '#101010', borderBottomColor: 'white', borderRadius: 7 }}
                                ...
                                />
                                <Text style={{ fontSize: 10, color: 'white', textAlign: 'center' }}>{props.touched.advance && props.errors.advance}</Text>
                                ...
                                />
                                <View style={{ flexDirection: 'row', height: 40, marginBottom: 15, backgroundColor: '#101010', borderWidth: 1, borderBottomColor: 'white', borderRadius: 7 }}>
                                ...
                                <View style={{ flexDirection: 'row', marginBottom: 20 }}>
                                    <View style={{ flex: 1, flexDirection: 'row', marginRight: 9 }}>
                                        <View style={{ flex: 1.5, justifyContent: 'center', alignItems: 'center', backgroundColor: '#101010', borderWidth: 1, borderColor: '#101010', borderBottomColor: 'white' }}>
                                            <Text style={{ color: 'white' }}>2 Wheeler</Text>
                                        </View>
                                        <View style={{ flex: 1, justifyContent: 'center', backgroundColor: '#101010', borderWidth: 1, borderBottomColor: 'white', borderColor: '#101010', alignItems: 'center' }}>
                                            <RadioButton
                                                value="2"
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'row', backgroundColor: 'white' }}>
                                        ...
                                        <View style={{
                                            flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#101010', borderWidth: 1, borderColor: '#101010', borderBottomColor: 'white'
                                        }}>
                                            <RadioButton
                                                value="4"
                ...
                <View style={{ height: 290, borderRadius: 22 }}>
                    <Text style={{ color: 'white', textAlign: 'center' }}>Tap for full Details</Text>
                    <View style={{ height: 263, backgroundColor: 'black', marginTop: 5, borderColor: 'gray', borderTopLeftRadius: 22, borderBottomColor: 'black', borderTopRightRadius: 22, borderWidth: 1 }}>
                ...
                <TouchableOpacity style={{ borderWidth: 1, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, borderTopWidth: 0, borderColor: 'gray', backgroundColor: 'black', flex: 2, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate('Member', details)} >
                    <Text style={{ fontSize: 16, color: 'white', fontWeight: 'bold' }}>SEE ALL</Text>
                </TouchableOpacity>
            </View>
